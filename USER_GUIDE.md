...
1. **Install the plugin** from the [Releases](https://github.com/assiliClubDev/revit-mcp-server/releases) page (do NOT copy source code from the repository)
...
|-------|-------|----------|
| **Only Switch button visible** (no MCP Panel or Settings) | Source code was copied instead of pre-built Release | Download the correct ZIP from the [Releases](https://github.com/assiliClubDev/revit-mcp-server/releases) page — do NOT copy `.cs` files from GitHub |
...
If you see `.cs` or `.csproj` files instead of `.dll` files, you copied the source code. Download the pre-built ZIP from [Releases](https://github.com/assiliClubDev/revit-mcp-server/releases) instead.
