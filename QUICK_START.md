...
| 3 | **Revit MCP Plugin** (ZIP file) | [Download from GitHub Releases](https://github.com/assiliClubDev/revit-mcp-server/releases) |
...
Go to the [Releases page](https://github.com/assiliClubDev/revit-mcp-server/releases) and download the ZIP that matches your Revit version:
...
| Source code instead of release | You should see `.dll` files, NOT `.cs` files. Download the ZIP from [Releases](https://github.com/assiliClubDev/revit-mcp-server/releases), not the source code |
